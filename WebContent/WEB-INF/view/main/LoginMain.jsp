				               	...
				               	<div class="col-sm-6">
				               		...
				               		<table class="table">
										...
										<tbody>
											<tr>
												<td>
													<a href='MyPage.do' onclick="window.name='MyPage.do';window.open(this.href, 'join', 'width=770,height=580');return false;">
					              			...
					              			<tr>
					              				<td>
					              					<button class="btn btn-warning" onclick="memberOut();">회원 탈퇴</button>
					              				</td>
									            <td>
									            	<button class="btn btn-warning" onclick="memberPwChg();">비밀번호 변경</button>
									            </td>
					              			</tr>
					    				</tbody>
									</table>
