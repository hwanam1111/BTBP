				             		...
				             		<button class="btn btn-warning btn-sm messagePage" id="${FriendVO.friendId}">
				             			...
				             			<c:choose>
				             				<c:when test="${FriendVO.noReadCount > 0}">
				             					<span class="label label-danger" style="position:absolute; bottom: 10px; font-size: 12px; padding-top: 3px; padding-right: 5px; padding-bottom: 3px; padding-left: 5px;">${FriendVO.noReadCount}</span>
				             				</c:when>
				             				<c:otherwise>
				             					<span class="label label-success" style="position:absolute; bottom: 10px; font-size: 12px; padding-top: 3px; padding-right: 5px; padding-bottom: 3px; padding-left: 5px;">${FriendVO.noReadCount}</span>
				             				</c:otherwise>
				             			</c:choose>
				             		</button>  
				            	</div>
