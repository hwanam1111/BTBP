			            ...
			            <div class="util_menu">
			                ...
			                <div class="util_box">
			                    <ul class="gnb">
			                        ...
			                        <li>
			                             <a href='MemberSavePage.do' onclick="window.name='MemberSavePage.do';window.open(this.href, 'join', 'width=770,height=580, left=350, top=50');return false;">회원가입</a>
			                        </li>
			                    </ul>
			                </div>
			            </div>
			...
			<div class="footer">
			    <div class="main_wrap">
			        <div class="foot_menu">
			            ...
			            <ul class="last">
			                <li>(주) BTBP소프트 경기도 성남시 분당구 대왕판교로 670 BTBP빌딩</li>
