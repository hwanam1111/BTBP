              ...
              <div class="chart tab-pane active" id="check1" style="position: relative;">
              	<div class="box box-primary">
			             <div class="box-header with-border">
				       	  	<h3 class="box-title"><i class="fa fa-inbox"></i>&nbsp;&nbsp;<b>파일 공유</b></h3>
				         </div>
						           ...
						           <c:if test="${!bList.isEmpty()}">
						             <c:forEach var="BoardVO" items="${bList}"> 
						                ...
						                <tr>
						                	...
						                	<c:set var="FileShareContent" value="${fn:substring(string1, 0, 15)}"/>
						                	<c:set var="BoardVO.boardCnt" value="${BoardVO.boardCnt}"/>
						                	<c:set var="BoardVO.fileName" value="${BoardVO.fileName}"/>
											 ...
											 <td>
												<a href="FileShareDetail.do?boardNo=${BoardVO.boardNo}&boardType=${BoardVO.boardType}&pageNo=${nowpagenum}">${BoardVO.boardTitle}</a>
											 </td>
...
<%-- 				                </c:if>  --%>
	            ...
	            <div class="box-footer">
	                ...
	                <div class="pull-left" style="margin-top:60px">
	                  <button type="button" class="btn btn-danger" id="FileShareDelete"><i class="fa fa-trash-o"></i> 삭제</button>
	                </div>
	                ...
	                <div class="pull-right" style="margin-top:60px">
	 					<a href="fileShareInsertForm.do?boardType=${status }&pageNo=${nowpagenum}">
	 						<button type="button" class="btn btn-success"><i class="fa fa-edit"></i> 파일 등록</button>
	 					</a>
	                 <!-- /.btn-write -->
	                </div>
	                 <!-- /.pull-right -->
	...
	<!-- 아이콘 형식 시작 부분 -->   
	<div class="chart tab-pane" id="check2" style="position: relative;"> <!-- 나중에 파일 길이에 따라 수정 -->
          <!-- 필요한 부분 입력 -->
          <div class="box box-primary">
			<div class="box-header with-border">
		              ...
		              <li style="width: 19.2%;">
		                <c:choose>
		                  ...
		                  <c:when test="${FileShareType == 'png' || FileShareType == 'img' || FileShareType == 'gif' || FileShareType == 'jpg' ||FileShareType == 'JPEG' }">
		                  	<span class="mailbox-attachment-icon has-img" style="height: 150px;">
