...
<script>
   $(function(){	   
	    ...
	    $('#ModifyCancel').click(function(){
		   ...
		   location.href="ProjectBoardDetail.do?boardNo="+boardNo+"&boardType=${bvo.boardType}";
...
// 				return;
// 			}		
// 			location.href="ProjectBoardInsert.do"
				var boardNo = ${bvo.boardNo};
      ...
      <div class="row">
       ...
       <div class="col-md-12">
         ...
         <div class="box box-solid">
          ...
          <div class="box-body">
            <form id="frm" action="ProjectBoardUpdate.do?boardNo=${bvo.boardNo}&boardType=${bvo.boardType}&pageNo=${nowpagenum}" method="post" enctype="multipart/form-data">
              	<div class="form-group">
              	  <input class="form-control" id="boardTitle" name="boardTitle" placeholder="제목" value="${bvo.boardTitle}">
              	</div>
              
              	<div class="form-group">
                		<div class="box-body pad">
							<textarea id="TeamBoardContent" name="boardContent" class="form-control"  rows="10" cols="80">${bvo.boardContent}</textarea>
	        			</div>                    
             	 </div>
		...
		<div class="box-footer">
			<div class="pull-right">
               <button type="button" id="ModifyOKBtn" class="btn btn-primary">
               		<i class="fa fa-check"></i> 수정 완료
               </button>
              
              
				<button type="button" id="ModifyCancel" class="btn btn-danger">
