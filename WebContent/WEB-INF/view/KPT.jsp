...
<html>
				...
				<section class="content">
					<div class="row clearfix">
						<div class="col-lg-4 col-md-6 col-sm-10 col-xs-10">
							<div class="card">
								<div class="header" style="background: #605ca8; text-align: center">
									<h2>
									...
									<ul class="header-dropdown m-r--5">
										<li class="dropdown">
											...
											<ul class="dropdown-menu pull-right">
												<li>
													<a href="#" id="keep" class="InsertPostIt">포스트잇 추가</a>
												</li>
												<li>
													<a href="#" class="deleteAll">모두 삭제</a>
												</li>
											</ul>
										</li>
									</ul>
													...
													<c:forEach var="kvo" items="${kptList}">
														<c:if test="${kvo.jobStatus eq 'keep'}">
															<li class="dd-item dd3-item">
																...
																<div class="dd3-content" style="height: 100px; border: 3px solid #FFFED7; background-color: #FFFED7">
																	<div class="direct-chat-msg">
																		<div class="direct-chat-info clearfix">
																			<span class="direct-chat-name pull-left" style="color: black">${kvo.memberName}</span> 
																			<span class="direct-chat-timestamp pull-right" style="color: black">${kvo.createDate}</span>
																		</div>
																		<img class="direct-chat-img"
																			src="/BTBP/resources/upload/Members/${kvo.memberImageName}"
																			alt="message user image"/>
																		<div class="direct-chat-text" style="background-color: white; border: 3px solid white;">
								...
								<div class="header" style="background: #605ca8; text-align: center;">
									...
									<ul class="header-dropdown m-r--5">
										<li class="dropdown">
											...
											<ul class="dropdown-menu pull-right">
												<li><a href="#" id="problem" class="InsertPostIt">포스트잇 추가</a></li>
								...
								<div class="clearfix m-b-20">
									<div class="dd nestable-with-handle">
										<ul id="doingArea" style="padding-left: 0px;">
											<li class="dd-item dd3-item" id="doing"></li>
											<c:if test="${!kptList.isEmpty()}">
												<c:forEach var="kvo" items="${kptList}">
														...
														<div class="dd-handle dd3-handle"></div>
															<div class="dd3-content" style="height: 100px; border: 3px solid #FFFED7; background-color: #FFFED7">
																<div class="direct-chat-msg">
																	...
																	<img class="direct-chat-img" src="/BTBP/resources/upload/Members/${kvo.memberImageName}" alt="message user image"/>
																	<div class="direct-chat-text" style="background-color: white; border: 3px solid white;">
																		<input type="hidden" id="contentKan" value="${kvo.jobContent }">
																		<input type="hidden" value="${kvo.memberCompany }">
																		<input type="hidden" value="${kvo.memberDept }">
						...
						<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
							<div class="card">
								<div class="header" style="background-color: #605ca8; text-align: center;">
									<h2>
									...
									<ul class="header-dropdown m-r--5">
										<li class="dropdown">
											...
											<ul class="dropdown-menu pull-right">
												<li><a href="#" id="try" class="InsertPostIt">포스트잇 추가</a></li>
									...
									<div class="clearfix m-b-20">
										<div class="dd nestable-with-handle">
											<ol class="dd-list" id="doneArea">
												<li class="dd-item dd3-item" id="done"></li>
												<c:if test="${!kptList.isEmpty()}">
													<c:forEach var="kvo" items="${kptList}">
					...
					<form id="frm1" action="">
						<div class="widget-user-header bg-white">
							<div class="widget-user-image">
								<img class="img-circle img-bordered-sm"src="/BTBP/resources/upload/Members/${mvo.memberImageName}" alt="User Avatar" id="myImg">
							</div>
						...
						<div class="box-footer no-padding">
									...
									<div class="box-body" style="height: 360px; padding: 20px;">
										<div class="form-group">
											...
											<div class="input-group">
												<span class="input-group-addon"><i class="fa fa-file-o"></i></span> <input type="text" id="jobTitle" name="jobTitle" class="form-control" placeholder="제목">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="input-group check">
												...
												<textarea id="kanbanContent" name="jobContent" class="form-control" placeholder="세부내용" style="height: 100px;"></textarea>
											</div>
										</div>
									</div>
								</div>
							...
							<div class="input-group pull-right" style="margin-left: 3px;">
								<a class="btn" id="modifyBtn"><i class="fa fa-file-text"></i> 수정</a>
							</div>
							<div class="input-group pull-right" style="margin-left: 3px;">
	...
	<div id="deleteall_modal" class="sweet-alert showSweetAlert visible"
		...
		<div class="sa-button-container">
			...
			<div class="sa-confirm-button-container" style="padding-right : 30px">
				<button class="confirm" tabindex="1" id="deleteall_confirm" style="display: inline-block; background-color: rgb(243, 134, 91); margin-left: 60px; margin-bottom: 5px">삭제</button>
	...
	<div id="delete_modal" class="sweet-alert showSweetAlert visible"
		...
		<div class="sa-button-container">
			<button class="cancel" tabindex="2" id="delete_cancel" style="display: inline-block; box-shadow: none; margin-left: 110px">취소</button>
			<div class="sa-confirm-button-container" style="padding-right : 30px">
				<button class="confirm" tabindex="1" id="delete_confirm" style="display: inline-block; background-color: rgb(243, 134, 91); margin-left: 60px; margin-bottom: 5px">삭제</button>
				<div class="la-ball-fall">
					<div></div>
					<div></div>
					<div></div>
	...
	<div id="modify_modal" class="sweet-alert showSweetAlert visible"
		...
		<div class="sa-button-container">
			<button class="cancel" tabindex="2" id="modify_cancel" style="display: inline-block; box-shadow: none; margin-left: 110px">취소</button>
			<div class="sa-confirm-button-container" style="padding-right : 30px">
				<button class="confirm" tabindex="1" id="modify_confirm" style="display: inline-block; background-color: rgb(243, 134, 91); margin-left: 60px; margin-bottom: 5px">수정</button>
				<div class="la-ball-fall">
					<div></div>
					<div></div>
					<div></div>
