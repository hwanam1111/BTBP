gantt = {
    ...
    function() {
        ...
        gantt._getFocusableNodes = function(i) {
            for (var s = i.querySelectorAll(["a[href]", "area[href]", "input", "select", "textarea", "button", "iframe", "object", "embed", "[tabindex]", "[contenteditable]"].join(", ")), r = Array.prototype.slice.call(s, 0), o = 0; o < r.length; o++) {
                var _ = r[o],
                    l = (e(_) || a(_) || n(_)) && t(_);
                l || (r.splice(o, 1), o--)
            }
        ...
        n = n || window.gantt, a.id = "gantt_" + n.uid(), a.style.width = "100%", a.style.height = "100%", a.cmp = "grid", document.body.appendChild(a), this.attachObject(a.id), this.dataType = "gantt", this.dataObj = n;
        ...
        n = n || window.gantt;
        var a = document.createElement("DIV");
        a.id = "gantt_" + n.uid(), a.style.width = "100%", a.style.height = "100%", a.cmp = "grid", document.body.appendChild(a), this.attachObject(a.id), this.dataType = "gantt", this.dataObj = n, n.init(a.id, t, e), a.firstChild.style.border = "none";
        return a = null, this.callEvent("_onContentAttach", []), this.dataObj
    }), gantt._eventable(gantt), gantt.config || (gantt.config = {}), gantt.config || (gantt.config = {}), gantt.templates || (gantt.templates = {}),
    function() {
        gantt.mixin(gantt.config, {
            ...
            n = n || t, this.config[t] && a[n] != this.config[t] && (e && this.templates[n] || (this.templates[n] = this.date.date_to_str(this.config[t]),
                a[n] = this.config[t])), this._reg_templates = a
    ...
    }(), gantt._click = {}, gantt._dbl_click = {}, gantt._context_menu = {}, gantt._on_click = function(t) {
        t = t || window.event;
        ...
        this._obj = t, e && (this._settings = e), gantt._eventable(this), this.initEventAccessor(), this._drag_start_timer = null, gantt.attachEvent("onGanttScroll", gantt.bind(function(t, e) {
            this.clearDragTimer()
        }, this)), gantt.event(t, this._evs.down, gantt.bind(function(n) {
            e.original_target = {
                target: n.target || n.srcElement
            }, gantt.config.touch ? (this.clearDragTimer(), this._drag_start_timer = setTimeout(gantt.bind(function() {
                this.dragStart(t, n)
            }, this), gantt.config.touch_drag)) : this.dragStart(t, n)
        }, this)), gantt.event(document.body, this._evs.up, gantt.bind(function(t) {
            this.clearDragTimer()
        }, this))
        ...
        traceDragEvents: function(t) {
            var e = gantt.bind(function(e) {
                ...
                n = (gantt.bind(function(e) {
                    return this.dragScroll(t, e)
                }, this), gantt.bind(function(t) {
                    return t && t.preventDefault && t.preventDefault(), (t || event).cancelBubble = !0, gantt.defined(this.config.updates_per_second) && !gantt._checkTimeout(this, this.config.updates_per_second) ? !0 : e(t)
                }, this)),
                a = gantt.bind(function(e) {
                    return gantt.eventRemove(document.body, this._evs.move, n), gantt.eventRemove(document.body, this._evs.up, a), this.dragEnd(t)
                }, this);
            gantt.event(document.body, this._evs.move, n), gantt.event(document.body, this._evs.up, a)
        },
        ...
        backupEventTarget: function(t) {
            if (gantt.config.touch) {
                ...
                this.config.original_target = {
                    target: a
                }, this.config.backup_element = n, n.parentNode.appendChild(a), n.style.display = "none", document.body.appendChild(n)
            }
        },
        initEventAccessor: function() {
            ...
            this.eventAccessor = function(t) {
                return t
            }, gantt.config.touch && (window.navigator.msPointerEnabled ? (t.move = "MSPointerMove", t.down = "MSPointerDown", t.up = "MSPointerUp", this.eventAccessor = function(t) {
                return t.pointerType == t.MSPOINTER_TYPE_MOUSE ? null : t
            }) : (t.move = "touchmove", t.down = "touchstart", t.up = "touchend", this.eventAccessor = function(t) {
        ...
        dragStart: function(t, e) {
            this.config = {
                ...
                sensitivity: 4
            }, this._settings && gantt.mixin(this.config, this._settings, !0), this.traceDragEvents(t), gantt._prevent_touch_scroll = !0, document.body.className += " gantt_noselect", gantt.config.touch && this.dragMove(t, e);
        },
            ...
            if (n) {
                if (!this.config.marker && !this.config.started) {
                    ...
                    if (gantt.config.touch || this.checkPositionChange(a)) {
                        ...
                        this.backupEventTarget(e), this.initDnDMarker(), gantt._touch_feedback(), this.callEvent("onAfterDragStart", [t, this.config.original_target])
                    } else this.config.ignore = !0
                }
                return this.config.ignore ? void 0 : (n.pos = this.getPosition(n), this.config.marker.style.left = n.pos.x + "px", this.config.marker.style.top = n.pos.y + "px", this.callEvent("onDragMove", [t, n]), !1)
            }
        },
        dragEnd: function(t) {
            var e = this.config.backup_element;
            e && e.parentNode && e.parentNode.removeChild(e), gantt._prevent_touch_scroll = !1, this.config.marker && (this.config.marker.parentNode.removeChild(this.config.marker), this.config.marker = null, this.callEvent("onDragEnd", [])), document.body.className = document.body.className.replace(" gantt_noselect", "");
        },
        ...
        for (var t = this.getGridColumns(), e = [], n = 0, a = this.locale.labels, i = this.config.scale_height - 2, s = 0; s < t.length; s++) {
            ...
            var l = this._sort && o.name == this._sort.name ? "<div class='gantt_sort gantt_" + this._sort.direction + "'></div>" : "",
            ...
            var c = this._waiAria.gridScaleCellAttrString(o, h),
                u = "<div class='" + d + "' style='" + g + "' " + c + " column_id='" + o.name + "'>" + h + l + "</div>";
            e.push(u)
        }
        ...
        for (var e, n = this.getGridColumns(), a = [], i = 0; i < n.length; i++) {
            var s, r, o, _ = i == n.length - 1,
                l = n[i];
            if ("add" == l.name) {
                var d = this._waiAria.gridAddButtonAttrString(l);
                r = "<div " + d + " class='gantt_add'></div>", o = ""
            } else r = l.template ? l.template(t) : t[l.name], r instanceof Date && (r = this.templates.date_grid(r, t)), o = r, r = "<div class='gantt_tree_content'>" + r + "</div>";
            var g = "gantt_cell" + (_ ? " gantt_last_cell" : ""),
                h = "";
            if (l.tree) {
                for (var c = 0; c < t.$level; c++) h += this.templates.grid_indent(t);
                e = this._has_children(t.id), e ? (h += this.templates.grid_open(t), h += this.templates.grid_folder(t)) : (h += this.templates.grid_blank(t), h += this.templates.grid_file(t));
            }
            var u = "width:" + (l.width - (_ ? 1 : 0)) + "px;";
            this.defined(l.align) && (u += "text-align:" + l.align + ";");
            var d = this._waiAria.gridCellAttrString(l, o);
            s = "<div class='" + g + "' style='" + u + "' " + d + ">" + h + r + "</div>", a.push(s)
        }
        var g = gantt.getGlobalTaskIndex(t.id) % 2 === 0 ? "" : " odd";
        if (g += t.$transparent ? " gantt_transparent" : "", g += t.$dataprocessor_class ? " " + t.$dataprocessor_class : "", this.templates.grid_row_class) {
            var f = this.templates.grid_row_class.call(this, t.start_date, t.end_date, t);
            f && (g += " " + f)
        }
        this.getState().selected_task == t.id && (g += " gantt_selected");
        var p = document.createElement("div");
        return p.className = "gantt_row" + g, p.style.height = this.config.row_height + "px", p.style.lineHeight = gantt.config.row_height + "px", p.setAttribute(this.config.task_attribute, t.id), this._waiAria.taskRowAttr(t, p), p.innerHTML = a.join(""), p
        ...
        if (t != n) {
            ...
            var i = this.getTask(t),
                ...
                r = (this.getChildren(this.getParent(i.id)),
                    this.getChildren(n));
            ...
            if (this.callEvent("onBeforeTaskMove", [t, n, e]) !== !1) {
                ...
                var _ = r[e];
                _ ? r = r.slice(0, e).concat([t]).concat(r.slice(e)) : r.push(t), this.setParent(i, n), this._branches[n] = r;
                ...
                1 * e > 0 ? a ? i.$drop_target = (this.getTaskIndex(t) > this.getTaskIndex(a) ? "next:" : "") + a : i.$drop_target = "next:" + gantt.getPrevSibling(t) : r[1 * e + 1] ? i.$drop_target = r[1 * e + 1] : i.$drop_target = n,
        ...
        this.defined(this.config.dnd_sensitivity) && (t.config.sensitivity = this.config.dnd_sensitivity), t.attachEvent("onBeforeDragStart", this.bind(function(e, n) {
            ...
            return a > e.y + i - this.config.row_height && (a = e.y + i - this.config.row_height), e.x = n, e.y = a, e
        }, this), t._getTargetY = this.bind(function(t) {
            var e = this._get_position(this.$grid_data),
                n = t.pageY - e.y + gantt.getScrollState().y;
            return 0 > n && (n = 0), n
        }, this), t._getTaskByY = this.bind(function(t, e) {
            t = t || 0, gantt.config.smart_rendering && (t += this.$grid_data.scrollTop);
            var n = Math.floor(t / this.config.row_height);
            return n = n > e ? n - 1 : n, n > this._order.length - 1 ? null : this._order[n];
        }, this), t.attachEvent("onDragMove", this.bind(function(e, n) {
            function a(t, e) {
                return !gantt.isChildOf(l.id, e.id) && (t.$level == e.$level || gantt.config.order_branch_free)
            }
            var i = t.config,
                s = t._getGridPos(n);
            i.marker.style.left = s.x + 10 + "px", i.marker.style.top = s.y + "px";
            var r = this.getTask(t.config.id),
                o = t._getTargetY(n),
                _ = t._getTaskByY(o, gantt.getGlobalTaskIndex(r.id));
            if (this.isTaskExists(_) || (_ = t.lastTaskOfLevel(gantt.config.order_branch_free ? r.$level : 0), _ == t.config.id && (_ = null)), this.isTaskExists(_)) {
                var l = this.getTask(_);
                if (gantt.getGlobalTaskIndex(l.id) * this.config.row_height + this.config.row_height / 2 < o) {
                    var d = this.getGlobalTaskIndex(l.id),
                        g = this._pull[this._order[d + 1]];
                    if (g) {
                        if (g.id == r.id) return this.config.order_branch_free && this.isChildOf(r.id, l.id) && 1 == this.getChildren(l.id).length ? void this.moveTask(r.id, this.getTaskIndex(l.id) + 1, this.getParent(l.id)) : void 0;
                        l = g
                    } else if (g = this._pull[this._order[d]], a(g, r) && g.id != r.id) return void this.moveTask(r.id, -1, this.getParent(g.id))
                ...
                for (var d = this.getGlobalTaskIndex(l.id), h = this._pull[this._order[d - 1]], c = 1;
                    (!h || h.id == l.id) && d - c >= 0;) h = this._pull[this._order[d - c]], c++;
                if (r.id == l.id) return;
                a(l, r) && r.id != l.id ? this.moveTask(r.id, 0, 0, l.id) : l.$level != r.$level - 1 || gantt.getChildren(l.id).length ? h && a(h, r) && r.id != h.id && this.moveTask(r.id, -1, this.getParent(h.id)) : this.moveTask(r.id, 0, l.id)
            }
            return !0
    ...
    function() {
        ...
        gantt._waiAria = {
            ...
            _taskCommonAttr: function(e, n) {
                n.setAttribute("aria-label", t(gantt.templates.tooltip_text(e.start_date, e.end_date, e))),
                    gantt._is_readonly(e) && n.setAttribute("aria-readonly", !0), e.$dataprocessor_class && n.setAttribute("aria-busy", !0), n.setAttribute("aria-selected", gantt.getState().selected_task == e.id || gantt.isSelectedTask && gantt.isSelectedTask(e.id) ? "true" : "false")
            },
            setTaskBarAttr: function(t, e) {
                this._taskCommonAttr(t, e), !gantt._is_readonly(t) && gantt.config.drag_move && (t.id != gantt.getState().drag_id ? e.setAttribute("aria-grabbed", !1) : e.setAttribute("aria-grabbed", !0))
            },
            taskRowAttr: function(t, e) {
                this._taskCommonAttr(t, e), !gantt._is_readonly(t) && gantt.config.order_branch && e.setAttribute("aria-grabbed", !1), e.setAttribute("role", "row"), e.setAttribute("aria-level", t.$level), gantt._has_children(t.id) && e.setAttribute("aria-expanded", t.$open ? "true" : "false")
            },
            linkAttr: function(e, n) {
                var a = gantt.config.links,
                    ...
                    r = gantt.locale.labels.link + " " + gantt.templates.drag_link(e.source, s, e.target, i);
                n.setAttribute("aria-label", t(r)),
                    gantt._is_readonly(e) && n.setAttribute("aria-readonly", !0)
            },
            ...
            gridScaleCellAttrString: function(t, e) {
                var n = "";
                if ("add" == t.name) n = this.getAttributeString({
                    role: "button",
                    ...
                    gantt._sort && gantt._sort.name == t.name && ("asc" == gantt._sort.direction ? a["aria-sort"] = "ascending" : a["aria-sort"] = "descending"),
        ...
        for (var r in gantt._waiAria) gantt._waiAria[r] = function(t) {
            return function() {
        ...
        prepareConfigs: function(t, e, n, a) {
            for (var i = this.splitSize(a, t.length), s = n, r = [], o = t.length - 1; o >= 0; o--) {
                ...
                _ && this.processIgnores(l), this.initColSizes(l, e, s, i[o]), this.limitVisibleRange(l), _ && (s = l.full_width),
                    r.unshift(l)
            }
        ...
        _ignore_time_config: function(t, e) {
            if (this.config.skip_off_time) {
                for (var n = !0, a = t, i = 0; i < e.step; i++) i && (a = gantt.date.add(t, i, e.unit)), n = n && !this.isWorkTime(a, e.unit);
                return n
            }
            return !1
        },
        ...
        initScaleConfig: function(t) {
            ...
            return this.eachColumn(t.unit, t.step, function(t) {
                e.count++, e.trace_x.push(new Date(t)), e.trace_indexes[t.valueOf()] = e.trace_x.length - 1
            }), e
        },
        iterateScales: function(t, e, n, a, i) {
            for (var s = e.trace_x, r = t.trace_x, o = n || 0, _ = a || r.length - 1, l = 0, d = 1; d < s.length; d++) {
                var g = t.trace_indexes[+s[d]];
                void 0 !== g && _ >= g && (i && i.apply(this, [l, d, o, g]), o = g, l = d)
            }
        },
        ...
        limitVisibleRange: function(t) {
            ...
            if (i) {
                for (var l = this.getSum(t.width), d = 0, g = 0; g < t.width.length; g++) {
        ...
        _resize: function(t, e, n) {
            ...
            n.left ? (t.start_date = gantt.dateFromPos(i.start + e), t.start_date || (t.start_date = new Date(gantt.getState().min_date))) : (t.end_date = gantt.dateFromPos(i.end + e),
                t.end_date || (t.end_date = new Date(gantt.getState().max_date))), t.end_date - t.start_date < a.min_duration && (n.left ? t.start_date = gantt.calculateEndDate(t.end_date, -1) : t.end_date = gantt.calculateEndDate(t.start_date, 1)), gantt._init_task_timing(t)
        },
        ...
        _move: function(t, e, n) {
            ...
            i ? s ? (t.start_date = i,
                t.end_date = s) : (t.end_date = new Date(gantt.getState().max_date), t.start_date = gantt.dateFromPos(gantt.posFromDate(t.end_date) - (a.end - a.start))) : (t.start_date = new Date(gantt.getState().min_date), t.end_date = gantt.dateFromPos(gantt.posFromDate(t.start_date) + (a.end - a.start)))
        },
        ...
        _update_on_move: function(t) {
            ...
            if (e.mode) {
                ...
                if (this._handlers[e.mode]) {
                    var r = gantt.mixin({}, s),
                        o = gantt.mixin({}, s);
                    this._handlers[e.mode].apply(this, [o, i, e]), gantt.mixin(s, o, !0), gantt.callEvent("onTaskDrag", [s.id, e.mode, o, r, t]),
                        gantt.mixin(s, o, !0), gantt._update_parents(e.id), gantt.refreshTask(e.id)
                }
            }
        },
        ...
        on_mouse_up: function(t) {
            ...
            if (e.mode && e.id) {
                ...
                if (gantt.config.work_time && gantt.config.correct_work_time && this._fix_working_times(n, e), this._fix_dnd_scale_time(n, e), gantt._init_task_timing(n), this._fireEvent("before_finish", e.mode, [e.id, e.mode, gantt.copy(e.obj), t])) {
                    var a = e.id;
                    gantt._init_task_timing(n), this.clear_drag_state(), gantt.updateTask(n.id), this._fireEvent("after_finish", e.mode, [a, e.mode, t]);
        ...
        _fireEvent: function(t, e, n) {
            ...
            return gantt.assert(a, "Unknown after drop mode:{" + e + "}"),
                gantt.assert(n, "Invalid event arguments"), gantt.checkEvent(a) ? gantt.callEvent(a, n) : !0
        }
        ...
        return t.color && (d.style.borderColor = t.color), i.appendChild(d), gantt._waiAria.linkAttr(t, i), i
        ...
        return n.style.cssText = ["top:" + i + "px", "left:" + s + "px"].join(";"), n.className = _,
            n
    }, gantt._drawer = {
        current_pos: null,
        dirs: {
        ...
        _get_line: function(t, e) {
            ...
            return n == this.dirs.left || n == this.dirs.right ? a.size = Math.abs(t.x - e.x) : a.size = Math.abs(t.y - e.y),
                a
        },
        ...
        get_points: function(t) {
            ...
            if (t.type == gantt.config.links.start_to_start) this.point_to(s.left, r), o ? (this.point_to(s.down, a), this.point_to(s.right, i)) : (this.point_to(s.right, i), this.point_to(s.down, a)), this.point_to(s.right, r);
                ...
                if (o = e.e_x > e.x + 2 * r,
                    this.point_to(s.right, r), o) i -= r, this.point_to(s.down, a), this.point_to(s.right, i);
                else {
                    i -= 2 * r;
                    var _ = a > 0 ? 1 : -1;
                ...
                if (o = e.e_x > e.x - 2 * r,
                    ...
                    i += 2 * r;
                    var _ = a > 0 ? 1 : -1;
                    this.point_to(s.down, _ * (n.row_height / 2)), this.point_to(s.right, i), this.point_to(s.down, _ * (Math.abs(a) - n.row_height / 2)), this.point_to(s.left, r)
        ...
        function s(t, e, n, i) {
            ...
            gantt.templates.link_direction_class && d.push(gantt.templates.link_direction_class(l.from, l.from_start, l.to, l.to_start));
        ...
        function _() {
            return d._direction || (d._direction = document.createElement("div"), gantt.$task_links.appendChild(d._direction)), d._direction
        }

        function l() {
            d._direction && (d._direction.parentNode && d._direction.parentNode.removeChild(d._direction), d._direction = null)
        }
        ...
        d.attachEvent("onBeforeDragStart", gantt.bind(function(e, n) {
            ...
            return !1
        }, this)), d.attachEvent("onAfterDragStart", gantt.bind(function(t, n) {
            this.config.touch && (this._show_link_points = !0,
                this.refreshData()), e(d.config.marker)
        }, this)), d.attachEvent("onDragMove", gantt.bind(function(a, i) {
            var r = d.config,
                o = d.getPosition(i);
            n(r.marker, o);
            ...
            var b = !(g == _ && l == f && c == p);
            return b && (l && gantt.refreshTask(l, !1), f && gantt.refreshTask(f, !1)), b && e(r.marker), s(this._dir_start.x, this._dir_start.y, this._dir_end.x, this._dir_end.y), !0
        }, this)), d.attachEvent("onDragEnd", gantt.bind(function() {
            var t = a();
            ...
            i(), this.config.touch ? (this._show_link_points = !1,
                this.refreshData()) : (t.from && gantt.refreshTask(t.from, !1), t.to && gantt.refreshTask(t.to, !1)), l()
        ...
        return this._task_area_pulls || (this._task_area_pulls = {}),
            this._task_area_renderers || (this._task_area_renderers = {}), this._task_area_renderers[t] ? this._task_area_renderers[t] : (e || this.assert(!1, "Invalid renderer call"), n && n.setAttribute(this.config.layer_attribute, !0), this._task_area_renderers[t] = {
                ...
                append: function(t, e, n) {
                    return e ? (this.rendered[t.id] && this.rendered[t.id].parentNode ? this.replace_item(t.id, e) : n.appendChild(e), void(this.rendered[t.id] = e)) : void(this.rendered[t.id] && this.remove_item(t.id))
                },
        ...
        for (var t = this._get_tasks_data(), e = this._get_task_renderers(), n = 0; n < e.length; n++) e[n].clear();
        ...
        for (var e = this._get_task_renderers(), n = 0; n < e.length; n++) e[n].render_items(t);
        var a = gantt._get_links_data();
        e = this._get_link_renderers();
        ...
        var e = Math.max(gantt._y - (gantt._scroll_sizes().x ? gantt._scroll_sizes().scroll_size + 1 : 0) - 1, 0);
        this.$task_data.style.height = Math.max(e - this.config.scale_height, 0) + "px", gantt.config.smart_rendering ? this.$task_bg.style.height = gantt.config.row_height * this.getVisibleTaskCount() + "px" : this.$task_bg.style.height = "", this.$task_bg.style.backgroundImage = "";
        ...
        if (this._is_grid_visible()) {
            for (var r = this.getGridColumns(), o = 0, a = 0; a < r.length; a++) o += r[a].width;
        ...
        this._min_date = a.start_date, this._max_date = a.end_date, this._max_date && this._max_date || (this._min_date = new Date, this._max_date = new Date(this._min_date)), this._min_date = this.date[t + "_start"](this._min_date), this._min_date = this.calculateEndDate(this.date[t + "_start"](this._min_date), -1, t), this._max_date = this.date[t + "_start"](this._max_date), this._max_date = this.calculateEndDate(this._max_date, 2, t)
        ...
        var o = 0,
            _ = t.count - 1;
        !this.config.smart_scales || isNaN(e) || isNaN(n) || (o = this._findBinary(t.left, e), _ = this._findBinary(t.left, n) + 1), r = t.css || function() {}, !t.css && this.config.inherit_scale_class && (r = gantt.templates.scale_cell_class);
        for (var l = o; _ > l && t.trace_x[l]; l++) {
            ...
            var d = s.call(this, i),
                ...
                p = "";
            if (g) {
                var v = this.config.smart_scales ? "position:absolute;left:" + c + "px" : "";
                u = "width:" + g + "px;height:" + h + "px;" + v,
                    p = "gantt_scale_cell" + (l == t.count - 1 ? " gantt_last_cell" : ""), f = r.call(this, i), f && (p += " " + f);
        ...
        for (var a = [], i = this.templates.scale_row_class, s = 0; s < t.length; s++) {
            var r = "gantt_scale_line",
                o = i(t[s]);
            o && (r += " " + o),
                a.push('<div class="' + r + '" style="height:' + t[s].height + "px;position:relative;line-height:" + t[s].height + 'px">' + this._prepare_scale_html(t[s], e, n) + "</div>")
        }
        return a.join("")
        ...
        if (this.config.smart_scales) {
            ...
            this.$task_scale.innerHTML = this._get_scale_chunk_html(t, e, e + this._x - this._get_grid_width())
        }
        ...
        if (this._is_chart_visible()) {
            ...
            var r = this._get_resize_options(),
                o = r.x ? Math.max(this.config.autosize_min_width, 0) : Math.max(this._x - this._get_grid_width() - 2, 0),
            ...
            e = l.full_width + (this._scroll_sizes().y ? d.scroll_size : 0) + "px", n = l.full_width + "px", a += "px"
        }
        ...
        if (gantt.config.show_task_cells)
            for (var i = 0; n > i; i++) {
                ...
                if (s > 0) {
                    ...
                    o.style.width = s + "px", r = "gantt_task_cell" + (i == n - 1 ? " gantt_last_cell" : ""), l = this.templates.task_cell_class(t, e.trace_x[i]), l && (r += " " + l), o.className = r, a.appendChild(o)
                }
            }
        var _ = t.$index % 2 !== 0,
            l = gantt.templates.task_row_class(t.start_date, t.end_date, t),
            d = "gantt_task_row" + (_ ? " odd" : "") + (l ? " " + l : "");
        return this.getState().selected_task == t.id && (d += " gantt_selected"), a.className = d, gantt.config.smart_rendering && (a.style.position = "absolute", a.style.top = this.getTaskTop(t.id) + "px",
            a.style.width = "100%"), a.style.height = gantt.config.row_height + "px", a.setAttribute(this.config.task_attribute, t.id), a
        ...
        this._get_safe_type(s.type) == this.config.types.milestone && a.push("gantt_milestone"),
            this._get_safe_type(s.type) == this.config.types.project && a.push("gantt_project"), this._is_flex_task(s) && a.push("gantt_dependent_task"), this.config.select_task && n == i.selected_task && a.push("gantt_selected"), n == i.drag_id && (a.push("gantt_drag_" + i.drag_mode), i.touch_drag && a.push("gantt_touch_" + i.drag_mode));
        var r = gantt._get_link_state();
        if (r.link_source_id == n && a.push("gantt_link_source"), r.link_target_id == n && a.push("gantt_link_target"), this.config.highlight_critical_path && this.isCriticalTask && this.isCriticalTask(s) && a.push("gantt_critical_task"),
            ...
            var o = r.link_source_id,
                ...
                g = "";
            g = d ? l ? "link_start_allow" : "link_finish_allow" : l ? "link_start_deny" : "link_finish_deny", a.push(g)
        }
        return a.join(" ")
        ...
        if (!this._isAllowedUnscheduledTask(t)) {
            ...
            (t.color || t.progressColor || t.textColor) && (l += " gantt_task_inline_color"),
            s.className = l;
            var d = ["left:" + e.x + "px", "top:" + (i + e.y) + "px", "height:" + a + "px", "line-height:" + a + "px", "width:" + r + "px"];
            t.color && d.push("background-color:" + t.color), t.textColor && d.push("color:" + t.textColor), s.style.cssText = d.join(";");
            var g = this._render_leftside_content(t);
            return g && s.appendChild(g), g = this._render_rightside_content(t), g && s.appendChild(g), gantt._waiAria.setTaskBarAttr(t, s), this._is_readonly(t) || (n.drag_resize && !this._is_flex_task(t) && o != this.config.types.milestone && gantt._render_pair(s, "gantt_task_drag", t, function(t) {
                ...
                var n = document.createElement("div");
                return n.className = "gantt_link_point", n.style.display = gantt._show_link_points ? "block" : "", e.appendChild(n), e
            })), s
        }
        ...
        var i = document.createElement("div"),
            s = Math.round(n * a);
        if (s = Math.min(n, s), t.progressColor && (i.style.backgroundColor = t.progressColor, i.style.opacity = 1), i.style.width = s + "px",
            i.className = "gantt_task_progress", i.innerHTML = this.templates.progress_text(t.start_date, t.end_date, t), e.appendChild(i), this.config.drag_progress && !gantt._is_readonly(t)) {
        ...
        return n == gantt._tasks.width.length && (i += gantt._tasks.width[gantt._tasks.width.length - 1]),
            a && (i += n < gantt._tasks.width.length ? gantt._tasks.width[n] * (a % 1) : 1), i
    ...
    }, gantt.addLinkLayer = gantt._add_generic_layer(gantt._link_layers, [gantt._filter_link, gantt._is_chart_visible].concat(gantt._get_link_filters())), gantt.removeLinkLayer = function(t) {
    ...
    }, gantt._pull = {}, gantt._branches = {}, gantt._order = [], gantt._lpull = {}, gantt._links = [],
    gantt._order_full = [], gantt.load = function(t, e, n) {
        this._load_url = t, this.assert(arguments.length, "Invalid load arguments");
        var a = "json",
            i = null;
        arguments.length >= 3 ? (a = e, i = n) : "string" == typeof arguments[1] ? a = arguments[1] : "function" == typeof arguments[1] && (i = arguments[1]), this._load_type = a, this.callEvent("onLoadStart", [t, a]), this.ajax.get(t, gantt.bind(function(e) {
            this.on_load(e, a), this.callEvent("onLoadEnd", [t, a]), "function" == typeof i && i.call(this)
        }, this))
        ...
        if (this._build_hierarchy(e), this._sync_order(), this._order_synced = !0, this._init_links(t.links || (t.collections ? t.collections.links : [])), this.callEvent("onParse", []),
            this.render(), this.config.initial_scroll) {
        ...
        t.id !== gantt.config.root_id && (this._order_full.push(t.id), !e && this._filter_task(t.id, t) && this.callEvent("onBeforeTaskDisplay", [t.id, t]) && (this._order.push(t.id),
        ...
        n = n || this;
        for (var a = e; this.getParent(a) && this.isTaskExists(this.getParent(a));) a = this.getTask(this.getParent(a)), t.call(n, a);
    }, gantt.json = {
        parse: function(t) {
        ...
        _getCollections: function(t) {
            for (var e = {}, n = gantt.ajax.xpath("//coll_options", t), a = 0; a < n.length; a++)
                for (var i = n[a].getAttribute("for"), s = e[i] = [], r = gantt.ajax.xpath(".//item", n[a]), o = 0; o < r.length; o++) {
                    for (var _ = r[o], l = _.attributes, d = {
        ...
        set_time: function(t) {
            var e = void 0 !== t.hours ? t.hours : !0,
                n = this._timestamp(t);
            null !== n ? this.get_calendar().dates[n] = e : this.get_calendar().hours = e, this._working_units_cache.clear()
        },
        get_calendar: function() {
            return gantt.config.worktimes && gantt.config.worktimes.global || this.reset_calendar(),
                gantt.config.worktimes.global
        },
        ...
        _check_is_working_unit: function(t, e, n) {
            return void 0 === n && (n = this._get_unit_order(e)), void 0 === n ? !0 : n && !this.is_working_unit(t, this.units[n - 1], n - 1) ? !1 : this["is_work_" + e] ? this["is_work_" + e](t) : !0
        },
        ...
        get_working_hours: function(t) {
            var e = this._timestamp({
                ...
                n = !0,
                a = this.get_calendar();
            return void 0 !== a.dates[e] ? n = a.dates[e] : void 0 !== a.dates[t.getDay()] && (n = a.dates[t.getDay()]), n === !0 ? a.hours : n ? n : []
        },
        intern_dates_pull: {},
        ...
        get_hours_per_day: function(t) {
            for (var e = this.get_working_hours(t), n = 0, a = 0; a < e.length; a += 2) n += e[a + 1] - e[a] || 0;
            return n
        },
        get_work_hours_for_range: function(t, e) {
            for (var n = 0, a = new Date(t), i = new Date(e); a.valueOf() < i.valueOf();) this.is_working_unit(a, "day") && (n += this.get_hours_per_day(a)), a = this.next_date(a, "day", 1);
            return n
        },
        get_work_units_between_hours: function(t, e, n, a) {
            ...
            if (s.valueOf() <= o.valueOf()) return this.get_work_units_between_generic(t, e, n, a);
        ...
        get_work_units_between: function(t, e, n, a) {
            return n ? "hour" == n ? this.get_work_units_between_hours(t, e, n, a) : this.get_work_units_between_generic(t, e, n, a) : !1
        },
        ...
        get_closest_worktime: function(t) {
            ...
            for ("past" == t.dir && (l = -1); !this.is_working_unit(n, e);) {
                ...
                if (n = gantt.date.add(n, l, e), n = gantt._correct_dst_change(n, d, l, e), gantt.date[e + "_start"] && (n = gantt.date[e + "_start"](n)), _ && (s ? a = n : i = n), s = !s, o++, o > r) return gantt.assert(!1, "Invalid working time check"), !1
            }
        ...
        return gantt.defined(e) || (e = this.getTask(t)), this.callEvent("onBeforeTaskUpdate", [t, e]) === !1 ? !1 : (this._pull[e.id] = e, this._is_parent_sync(e) || this._resync_parent(e), this._isAllowedUnscheduledTask(e) && (this._init_task(e), this._sync_links()), this._update_parents(e.id), this.refreshTask(e.id),
            this.callEvent("onAfterTaskUpdate", [t, e]), this._sync_order(), void this._adjust_scales())
        ...
        return gantt.defined(e) || (e = this.getParent(t) || 0), this.isTaskExists(e) || (e = 0), this.setParent(t, e), t = this._init_task(t), this.callEvent("onBeforeTaskAdd", [t.id, t]) === !1 ? !1 : (this._pull[t.id] = t, this._add_branch(t, n), this.callEvent("onAfterTaskAdd", [t.id, t]), this.refreshData(), this._adjust_scales(), t.id)
        ...
        if (t = t || {}, gantt.defined(t.id) || (t.id = gantt.uid()), t.start_date || (t.start_date = gantt._default_task_date(t, e)), void 0 === t.text && (t.text = gantt.locale.labels.new_task), void 0 === t.duration && (t.duration = 1), e) {
            this.setParent(t, e);
            var a = this.getTask(e);
            a.$open = !0
        }
        return this.callEvent("onTaskCreated", [t]) ? (this.config.details_on_create ? (t.$new = !0, this._pull[t.id] = this._init_task(t), this._add_branch(t, n), t.$level = this.calculateTaskLevel(t), this.selectTask(t.id), this.refreshData(), this.showLightbox(t.id)) : this.addTask(t, e, n) && (this.showTask(t.id),
            this.selectTask(t.id)), t.id) : null
        ...
        var e = this.getTask(t);
        if (!e) return [];
        for (var n = [], a = this.getChildren(e.id), i = 0; i < a.length; i++) n.push(a[i]),
            n = n.concat(this._getTaskTree(a[i]));
        return n
        ...
        var n = this._dp && !e,
            a = "";
        n && (a = this._dp.updateMode, this._dp.setGanttMode("tasks"),
        ...
        return this._deleteRelatedTasks(t, e),
            this._deleteRelatedLinks(a, e), this._unset_task(t), e || (this.callEvent("onAfterTaskDelete", [t, n]), this.refreshData()), !0
        ...
        this._pull[e].id = e, delete this._pull[t], this._update_flags(t, e), this._replace_branch_child(this.getParent(n), t, e);
        ...
        gantt.defined(t.id) || (t.id = gantt.uid()), t.start_date && (t.start_date = gantt.date.parseDate(t.start_date, "xml_date")), t.end_date && (t.end_date = gantt.date.parseDate(t.end_date, "xml_date"));
        var e = null;
        return (t.duration || 0 === t.duration) && (e = t.duration),
            e && (t.start_date && !t.end_date ? t.end_date = this.calculateEndDate(t.start_date, t.duration) : !t.start_date && t.end_date && (t.start_date = this.calculateEndDate(t.end_date, -t.duration))), this._isAllowedUnscheduledTask(t) && this._set_default_task_timing(t), gantt._init_task_timing(t), t.start_date && t.end_date && gantt.correctTaskWorkTime(t), t.$source = [], t.$target = [], void 0 === t.parent && this.setParent(t, this.config.root_id), gantt.defined(t.$open) || (t.$open = gantt.defined(t.open) ? t.open : this.config.open_tree_initially),
            t.$level = this.calculateTaskLevel(t), t
    }, gantt._init_task_timing = function(t) {
        var e = this._get_safe_type(t.type);
        void 0 === t.$rendered_type ? t.$rendered_type = e : t.$rendered_type != e && (delete t.$no_end, delete t.$no_start, t.$rendered_type = e), void 0 !== t.$no_end && void 0 !== t.$no_start || e == this.config.types.milestone || (e == this.config.types.project ? (t.$no_end = t.$no_start = !0, this._set_default_task_timing(t)) : (t.$no_end = !(t.end_date || t.duration), t.$no_start = !t.start_date, this._isAllowedUnscheduledTask(t) && (t.$no_end = t.$no_start = !1))),
            e == this.config.types.milestone && (t.end_date = t.start_date), t.start_date && t.end_date && (t.duration = this.calculateDuration(t.start_date, t.end_date)), t.duration = t.duration || 0
        ...
        t.$no_start && (e && e != 1 / 0 ? t.start_date = new Date(e) : t.start_date = this._default_task_date(t, this.getParent(t))), t.$no_end && (n && n != -(1 / 0) ? t.end_date = new Date(n) : t.end_date = this.calculateEndDate(t.start_date, this.config.duration_step)),
        ...
        if (r == gantt._tasks.unit && s == gantt._tasks.step && +i >= +gantt._min_date && +i <= +gantt._max_date) a = Math.floor(gantt._day_index_by_date(i)), gantt._tasks.trace_x[a] || (a -= 1), n = new Date(gantt._tasks.trace_x[a]), e = new Date(n), e = gantt._tasks.trace_x[a + 1] ? new Date(gantt._tasks.trace_x[a + 1]) : gantt.date.add(n, s, r);
            ...
            for (a = Math.floor(gantt._day_index_by_date(i)), e = gantt.date[r + "_start"](new Date(this._min_date)), gantt._tasks.trace_x[a] && (e = gantt.date[r + "_start"](gantt._tasks.trace_x[a])); + i > +e;) {
                e = gantt.date[r + "_start"](gantt.date.add(e, s, r));
                var o = e.getTimezoneOffset();
                e = gantt._correct_dst_change(e, o, e, r), gantt.date[r + "_start"] && (e = gantt.date[r + "_start"](e))
            }
        ...
        var e = null;
        return e = void 0 !== t.id ? t : gantt.getTask(t),
        ...
        function e(e) {
            for (var n = t.updatedRows.slice(), a = !1, i = 0; i < n.length && !t._in_progress[e]; i++) n[i] == e && ("inserted" == gantt.getUserData(e, "!nativeeditor_status") && (a = !0),
                t.setUpdated(e, !1));
            return a
        }
        t.setTransactionMode("POST", !0), t.serverProcessor += (-1 != t.serverProcessor.indexOf("?") ? "&" : "?") + "editing=true", t._serverProcessor = t.serverProcessor, t.styles = {
            ...
            var i = !e(n);
            i && (t.setUpdated(n, !0, "deleted"), "off" == t.updateMode || t._tSend || t.sendAllData())
        ...
        this.attachEvent("onTaskIdChange", function(e, i) {
            ...
            (n || a) && (gantt.batchUpdate(function() {
        ...
        t.afterUpdate = function() {
            ...
            var n = t._ganttMode,
                a = e.filePath;
            n = "REST" != this._tMode ? -1 != a.indexOf("gantt_mode=links") ? "links" : "tasks" : a.indexOf("/link") > a.indexOf("/task") ? "links" : "tasks", t.setGanttMode(n);
        ...
        return gantt.assert(n, "Link " + i + " not found. Task id=" + a + ", link id=" + t.id),
            n
        ...
        return t = this._init_link(t), this.callEvent("onBeforeLinkAdd", [t.id, t]) === !1 ? !1 : (this._lpull[t.id] = t, this._sync_links(), this._render_link(t.id), this.callEvent("onAfterLinkAdd", [t.id, t]),
            t.id)
    ...
    gantt.showLightbox = function(t) {
        ...
        if (void 0 === t && (t = this.getLightboxType()), !this._lightbox || this.getLightboxType() != this._get_safe_type(t)) {
            ...
            for (var a, i = this._lightbox_template, s = this.config.buttons_left, r = 0; r < s.length; r++) {
                var o = this.config._migrate_buttons[s[r]] ? this.config._migrate_buttons[s[r]] : s[r];
                a = this._waiAria.lightboxButtonAttrString(o), i += "<div " + a + " class='gantt_btn_set gantt_left_btn_set " + o + "_set'><div dhx_button='1' class='" + o + "'></div><div>" + this.locale.labels[o] + "</div></div>"
            }
            s = this.config.buttons_right;
            for (var r = 0; r < s.length; r++) {
                var o = this.config._migrate_buttons[s[r]] ? this.config._migrate_buttons[s[r]] : s[r];
                a = this._waiAria.lightboxButtonAttrString(o), i += "<div " + a + " class='gantt_btn_set gantt_right_btn_set " + o + "_set' style='float:right;'><div dhx_button='1' class='" + o + "'></div><div>" + this.locale.labels[o] + "</div></div>";
            }
            i += "</div>", e.innerHTML = i, gantt._waiAria.lightboxAttr(e), gantt.config.drag_lightbox && (e.firstChild.onmousedown = gantt._ready_to_dnd, e.firstChild.onselectstart = function() {
                return !1
            ...
            for (var r = 0; r < _.length; r++) {
                ...
                if (g.id && document.getElementById(g.id)) {
                    ...
                    if (u) {
                        ...
                        f && (g.inputId = f.id || "input_" + gantt.uid(), f.id || (f.id = g.inputId), c.setAttribute("for", g.inputId))
                    }
                }
            }
        ...
        var n = t,
            ...
            i = [];
        gantt.templates.lightbox_header ? (i.push(""), i.push(gantt.templates.lightbox_header(n.start_date, n.end_date, n)), a[1].innerHTML = "", a[2].innerHTML = gantt.templates.lightbox_header(n.start_date, n.end_date, n)) : (i.push(this.templates.task_time(n.start_date, n.end_date, n)), i.push((this.templates.task_text(n.start_date, n.end_date, n) || "").substr(0, 70)), a[1].innerHTML = this.templates.task_time(n.start_date, n.end_date, n), a[2].innerHTML = (this.templates.task_text(n.start_date, n.end_date, n) || "").substr(0, 70)),
            a[1].innerHTML = i[0], a[2].innerHTML = i[1], gantt._waiAria.lightboxHeader(e, i.join(" "));
        ...
        this.event(document.body, "mousemove", gantt._move_while_dnd),
            this.event(document.body, "mouseup", gantt._finish_dnd), gantt._init_dnd_events = function() {}
            ...
            for (var o = "", _ = 0; _ < n.length; _++) {
                ...
                switch (l) {
                    case "%Y":
                        ...
                        var g, h, c, u;
                        t.year_range && (isNaN(t.year_range) ? t.year_range.push && (c = t.year_range[0], u = t.year_range[1]) : g = t.year_range), g = g || 10, h = h || Math.floor(g / 2), c = c || i.getFullYear() - h, u = u || c + g;
                        for (var f = c; u > f; f++) d += "<option value='" + f + "'>" + f + "</option>";
                        break;
                    case "%m":
                        t._time_format_order[1] = _, t._time_format_order.size++;
                        for (var f = 0; 12 > f; f++) d += "<option value='" + f + "'>" + this.locale.date.month_full[f] + "</option>";
                        break;
                    case "%d":
                        t._time_format_order[0] = _, t._time_format_order.size++;
                        for (var f = 1; 32 > f; f++) d += "<option value='" + f + "'>" + f + "</option>";
                        break;
                    case "%H:%i":
                        ...
                        for (t._time_values = []; s > f;) {
                            ...
                            d += "<option value='" + f + "'>" + v + "</option>", t._time_values.push(f), i.setTime(i.valueOf() + 60 * this._get_timepicker_step() * 1e3);
        ...
        select: {
            ...
            set_value: function(t, e, n, a) {
                var i = t.firstChild;
                !i._dhx_onchange && a.onchange && (i.onchange = a.onchange, i._dhx_onchange = !0), "undefined" == typeof e && (e = (i.options[0] || {}).value), i.value = e || ""
            },
            get_value: function(t, e) {
        ...
        time: {
            ...
            set_value: function(t, e, n, a) {
                ...
                if (i.auto_end_date)
                    for (var o = function() {
                            d = new Date(s[r[2]].value, s[r[1]].value, s[r[0]].value, 0, 0), g = gantt.calculateEndDate(d, 1), this.form_blocks._fill_lightbox_select(s, r.size, g, r, i)
                ...
                this.form_blocks._fill_lightbox_select(s, 0, d, r, i),
            ...
            get_value: function(t, e, n) {
                ...
                var l = new Date(a[i[2] + i.size].value, a[i[1] + i.size].value, a[i[0] + i.size].value, s, r);
        ...
        duration: {
            render: function(t) {
                ...
                var n = this.locale.labels[this.config.duration_unit + "s"],
                    ...
                    r = "<div class='gantt_duration' " + a + "><input type='button' class='gantt_duration_dec' value='−'" + i + "><input type='text' value='5' class='gantt_duration_value'" + i + " " + s + "><input type='button' class='gantt_duration_inc' value='+'" + i + "> " + n + " <span></span></div>",
                    o = "<div style='height:" + (t.height || 30) + "px;padding-top:0px;font-size:inherit;' class='gantt_section_time'>" + e + " " + r + "</div>";
                return o
            },
            set_value: function(t, e, n, a) {
                function i() {
                ...
                function s(t) {
                    var e = l.value;
                    e = parseInt(e, 10), window.isNaN(e) && (e = 0), e += t, 1 > e && (e = 1), l.value = e, i()
                }
                var r = a,
                ...
                d[0].onclick = gantt.bind(function() {
                    ...
                    s(1 * this.config.duration_step)
                }, this), o[0].onchange = i, o[1].onchange = i, o[2].onchange = i, o[3] && (o[3].onchange = i), l.onkeydown = gantt.bind(function(t) {
                    t = t || window.event;
                ...
                gantt.form_blocks._fill_lightbox_select(o, 0, u, h, r), l.value = p, i()
            },
            ...
            if (t) {
                ...
                if ("GET" == this._tMode) gantt.ajax.get(i + (-1 != i.indexOf("?") ? "&" : "?") + this.serialize(t, e), a);
                    ...
                    if ("inserted" == s ? o = this.serialize(t, e) : "deleted" == s ? (_ = "DELETE", r = r + ("/" == r.slice(-1) ? "" : "/") + e) : (_ = "PUT", o = this.serialize(t, e), r = r + ("/" == r.slice(-1) ? "" : "/") + e), this._payload)
                        for (var l in this._payload) r = r + this._urlSeparator(r) + this.escape(l) + "=" + this.escape(this._payload[l]);
                    gantt.ajax.query({
                        url: r,
                        method: _,
            ...
            switch (n) {
                ...
                case "deleted":
                    return this.obj.setUserData(t, this.action_param, "true_deleted"), this.obj[this._methods[3]](t),
                        delete this._in_progress[i], this.callEvent("onAfterUpdate", [t, n, e, a])
            }
        ...
        finalizeUpdate: function() {
            this._waitMode && this._waitMode--,
                ("tree" == this.obj.mytype || this.obj._h2) && this.updatedRows.length && this.sendData(), this.callEvent("onAfterUpdateFinish", []), this.updatedRows.length || this.callEvent("onFullSync", [])
        },
        init: function(t) {
        ...
        setAutoUpdate: function(t, e) {
            t = t || 2e3, this._user = e || (new Date).valueOf(), this._need_update = !1,
                this._update_busy = !1, this.attachEvent("onAfterUpdate", function(t, e, n, a) {
        ...
        this.callEvent("onBeforeGanttReady", []), e && n && (this.config.start_date = this._min_date = new Date(e), this.config.end_date = this._max_date = new Date(n)), this._init_skin(), this.date.init(), this.config.scroll_size || (this.config.scroll_size = this._detectScrollSize()), gantt.event(window, "resize", this._on_resize), this.init = function(t) {
        ...
        var e = this._waiAria.gridAttrString(),
            ...
            a = "<div class='gantt_container'><div class='gantt_grid' " + e + "></div><div class='gantt_task'></div>";
        a += "<div class='gantt_ver_scroll'><div></div></div><div class='gantt_hor_scroll'><div></div></div></div>", this._obj.innerHTML = a, this.$container = this._obj.firstChild;
        var i = this.$container.childNodes;
        this.$grid = i[0], this.$task = i[1], this.$scroll_ver = i[2], this.$scroll_hor = i[3], this.$grid.innerHTML = "<div class='gantt_grid_scale' " + gantt._waiAria.gridScaleRowAttrString() + "></div><div class='gantt_grid_data' " + n + "></div>", this.$grid_scale = this.$grid.childNodes[0], this.$grid_data = this.$grid.childNodes[1], this.$task.innerHTML = "<div class='gantt_task_scale'></div><div class='gantt_data_area'><div class='gantt_task_bg'></div><div class='gantt_links_area'></div><div class='gantt_bars_area'></div></div>",
            this.$task_scale = this.$task.childNodes[0], this.$task_data = this.$task.childNodes[1], this.$task_bg = this.$task_data.childNodes[0], this.$task_links = this.$task_data.childNodes[1], this.$task_bars = this.$task_data.childNodes[2]
    }, gantt.$click = {
        buttons: {
            edit: function(t) {
        ...
        return this._is_chart_visible() || (e = 0),
            this._is_grid_visible() || (t = 0), t + e + 1
        ...
        return i.borderBox ? (i.innerWidth -= i.horPaddings, i.innerHeight -= i.vertPaddings) : (i.outerWidth += i.horPaddings,
            i.outerHeight += i.vertPaddings), i
        ...
        1 * t == t && (this.$task.scrollLeft = t, this._save_scroll_state(t, void 0)), 1 * e == e && (this.$scroll_ver.scrollTop = e, this.$task_data.scrollTop = e, this.$grid_data.scrollTop = e, this._save_scroll_state(void 0, this.config.show_chart ? this.$task_data.scrollTop : this.$scroll_ver.scrollTop));
        ...
        var e, n = this._get_task_pos(this.getTask(t)),
        ...
        var t = this.copy(this._restore_scroll_state()),
            e = null;
        if (t && (e = gantt.dateFromPos(t.x + this.config.task_scroll_offset)), this._render_grid(), this._render_tasks_scales(),
            this._scroll_resize(), this._on_resize(), this._render_data(), this.config.preserve_scroll && t) {
        ...
        function t(t) {
            ...
            if (a && Math.abs(a) > Math.abs(i)) {
                ...
                if (gantt.scrollTo(null, l),
                    gantt.$scroll_ver.scrollTop = l, _ == gantt.$scroll_ver.scrollTop) return !0
            }
        ...
        return _ && (l.x = Math.max(this._x - (r ? a : 2), 0)), r && (l.y = Math.max(this._y - (_ ? a : 0) - this.config.scale_height, 0)), l;
    ...
    function() {
        ...
        gantt._disableMethod = function(e, n) {
            n = "function" == typeof n ? n : function() {}, t[e] || (t[e] = this[e], this[e] = n)
        ...
        this._disableMethods(s), this._skip_render = !0, this.callEvent("onBeforeBatchUpdate", []), this._batchUpdatePayload(t), this.callEvent("onAfterBatchUpdate", []), this._restoreMethods(), this._sync_order(), this._sync_links();
        for (var r in i) this.resetProjectDates(i[r]);
        this._adjust_scales(), this._skip_render = !1, e || this.render(), a && (this._dp.setUpdateMode(n), this._dp.setGanttMode("tasks"), this._dp.sendData(), this._dp.setGanttMode("links"), this._dp.sendData());
    }, gantt.env = {
    ...
    function() {
            ...
            if (c) {
                ...
                if (gantt.message.keyboard) {
                    if (13 == n || 32 == n) {
                        ...
                        gantt._getClassName(i).indexOf("gantt_popup_button") > -1 && i.click ? i.click() : (t(c, !0), a = !0)
                    }
                    27 == n && (t(c, !1),
                        a = !0)
                }
        ...
        function a(t, e) {
            var n = gantt._waiAria.messageButtonAttrString(t),
                a = "gantt_" + t.toLowerCase().replace(/ /g, "_") + "_button dhtmlx_" + t.toLowerCase().replace(/ /g, "_") + "_button";
            return "<div " + n + " class='gantt_popup_button dhtmlx_popup_button " + a + "' result='" + e + "' ><div>" + t + "</div></div>";
        }

        function i(t) {
            u.area || (u.area = document.createElement("DIV"), u.area.className = "gantt_message_area dhtmlx_message_area", u.area.style[u.position] = "5px", document.body.appendChild(u.area)), u.hide(t.id);
            var e = document.createElement("DIV");
            return e.innerHTML = "<div>" + t.text + "</div>", e.className = "gantt-info dhtmlx-info gantt-" + t.type + " dhtmlx-" + t.type, e.onclick = function() {
                    u.hide(t.id), t = null
                }, gantt._waiAria.messageInfoAttr(e), "bottom" == u.position && u.area.firstChild ? u.area.insertBefore(e, u.area.firstChild) : u.area.appendChild(e),
        ...
        function r(e, n, i) {
            var r = document.createElement("DIV"),
                o = gantt.uid();
            gantt._waiAria.messageModalAttr(r, o), r.className = " gantt_modal_box dhtmlx_modal_box gantt-" + e.type + " dhtmlx-" + e.type, r.setAttribute("dhxbox", 1);
            var _ = "";
            if (e.width && (r.style.width = e.width), e.height && (r.style.height = e.height), e.title && (_ += '<div class="gantt_popup_title dhtmlx_popup_title">' + e.title + "</div>"),
                _ += '<div class="gantt_popup_text dhtmlx_popup_text" id="' + o + '"><span>' + (e.content ? "" : e.text) + '</span></div><div  class="gantt_popup_controls dhtmlx_popup_controls">', n && (_ += a(s(e.ok, gantt.locale.labels.message_ok, "OK"), !0)), i && (_ += a(s(e.cancel, gantt.locale.labels.message_cancel, "Cancel"), !1)), e.buttons)
                for (var l = 0; l < e.buttons.length; l++) _ += a(e.buttons[l], l);
            if (_ += "</div>", r.innerHTML = _, e.content) {
                var d = e.content;
                "string" == typeof d && (d = document.getElementById(d)), "none" == d.style.display && (d.style.display = ""),
                    r.childNodes[e.title ? 1 : 0].appendChild(d)
            }
        ...
        function o(t, a, i) {
            ...
            var o = Math.abs(Math.floor(((window.innerWidth || document.documentElement.offsetWidth) - s.offsetWidth) / 2)),
                _ = Math.abs(Math.floor(((window.innerHeight || document.documentElement.offsetHeight) - s.offsetHeight) / 2));
            return "top" == t.position ? s.style.top = "-3px" : s.style.top = _ + "px", s.style.left = o + "px", s.onkeydown = e, gantt.modalbox.focus(s), t.hidden && gantt.modalbox.hide(s), gantt.callEvent("onMessagePopup", [s]), s
        }
        ...
        function h(t, e, n, a) {
            return "object" != typeof t && (t = {
                    ...
                    expire: n,
                    id: a
                }), t.id = t.id || u.uid(), t.expire = t.expire || u.expire,
                t
        }
        var c = null;
        document.attachEvent ? document.attachEvent("onkeydown", e) : document.addEventListener("keydown", e, !0), gantt.alert = function() {
            ...
            t && (t.parentNode.removeChild(t),
                n(!1), gantt.callEvent("onAfterMessagePopup", [t]))
        ...
        u.seed = (new Date).valueOf(), u.uid = function() {
                return u.seed++
            }, u.expire = 4e3, u.keyboard = !0, u.position = "top",
        ...
        date: {
            month_full: ["1월", "2월", "3월", "4일", "5월", "6월", "7월", "8월", "9월", "10월", "11월", "12월"],
            month_short: ["1월", "2월", "3월", "4일", "5월", "6월", "7월", "8월", "9월", "10월", "11월", "12월"],
        ...
        labels: {
            ...
            icon_delete: "삭제",
            confirm_closing: "",
            confirm_deleting: "해당 작업을 삭제하시겠습니까?",
        ...
        var s, r = 0,
            ...
            d = null,
            g = null;
        this._gantt_touch_event_ready || (this._gantt_touch_event_ready = 1, gantt.event(gantt.$container, t[0], function(t) {
            if (!n(t) && o) {
                d && clearTimeout(d);
                var i = e(t);
                if (gantt._tasks_dnd.drag.id || gantt._tasks_dnd.drag.start_drag) return gantt._tasks_dnd.on_mouse_move(i), t.preventDefault && t.preventDefault(),
                    t.cancelBubble = !0, !1;
            ...
            if (!n(t)) {
                ...
                d = setTimeout(function() {
                    ...
                    !t || gantt._locate_css(l, "gantt_link_control") || gantt._locate_css(l, "gantt_grid_data") || (gantt._tasks_dnd.on_mouse_down(l), gantt._tasks_dnd.drag && gantt._tasks_dnd.drag.start_drag && (i(t), gantt._tasks_dnd._start_dnd(l), gantt._touch_drag = !0, gantt.refreshTask(t), gantt._touch_feedback())), d = null
